  <section class="content"><!-- Main content -->
    <div class="box box-primary"><!-- Horizontal Form -->
      <div class="box-header with-border">
        <h3 class="box-title"><?=$this->lang->line('form_title_productcategoryadd')?></h3>
      </div><!-- /.box-header -->
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class="btn-toolbar col-sm-4">
              <button type="submit" class="btn btn-primary pull-right" name="addProdCat" value="addProdCat"><i class="fa fa-check"></i> <?=$this->lang->line('button_submit')?></button>   
              <button type="button" class="btn btn-default pull-right" onclick="location.href='<?=base_url('admin/productcategory') ?>';"><i class="fa fa-angle-left"></i>    <?=$this->lang->line('button_cancel')?></button>
            </div>
          </div>
        </div><!-- /.box-body -->
      </form><!-- /.form -->
