          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
              <div class="btn-toolbar pull-right">
                <button type="submit" id="addButton" name="addBlogCategory" value="addBlogCategory" class="btn btn-primary pull-right"><i class="fa fa-check"></i> <?=$this->lang->line('button_submit')?></button>   
